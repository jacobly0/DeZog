...
# -*- coding: UTF-8 -*-
"""
Transform a fasmg-ez80 lst output in a "DeZog" list compatible one and
creates also symbols file compatible with EightyOne and No$Zx emulators
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
"""
    ...
    b. one single list file is used to specify multiple sources (included)
       <source file>|<src line>|<definition file>|<def line>|<page>|<value>|<type>|<data>
          ...
          6. memory address of label or instruction
          7. T for instruction Trace, L for Label
          8. empty for T, for L labels: module name, main label, local label (all separated by commas)
    c. some lines are added at the beginning to complete the file:
          1. "|SLD.data.version|1"
          2. "||K|KEYWORDS|WPMEM,LOGPOINT,ASSERTION"
          3. "{mainfile}|-1||0|-1|-1|Z|pages.size:0,pages.count:0,slots.count:0"
"""
...
def main():
    ...
    with open(fileIn, "r") as fpIn, open(fileOut, "w") as fpOut, open(
        ...
        fpOutSym.write(";EightyOne and No$Zx emulators debugging symbolic information file\n")
